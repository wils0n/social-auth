...
"""
Django settings for python_social_auth project.
...
SECRET_KEY = '&%---xr5r2q7dl2az6q8u89w$byna#n+pxb&^t+4^h(f6vfahy'
...
ROOT_URLCONF = 'python_social_auth.urls'

WSGI_APPLICATION = 'python_social_auth.wsgi.application'
